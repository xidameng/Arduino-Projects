...
void setup() {
  ...
  timer.attach_ms(1000,temp_hrspo2);//every 1 second call function to take 1 set of data from Temperature and HRSpO2
}
...
void temp_hrspo2(){
  ...
  Serial.println("Retriving temp and hrspo2 data now...");
...
///////////////////////
  ...
  Wire.requestFrom(8, 4); /* request data of size 4 from beetle at address 8 */
  //used to be (8,7)
...
//////////////////////////
  ...
  Wire.requestFrom(9, 5); /* request data of size 5 from beetle at address 9 */
  ...
  if(Wire.available()){
    ...
    int hcount = 0;
    while(Wire.available() && hcount <5){ //check for 5 bytes of data
...
//////////////////////////////////////////////////////////////////////////
/*  looping ECG data all the time except when "temp_hrspo2" timer triggers  */
//////////////////////////////////////////////////////////////////////////
  
  ECG();
  delay(150); // Publish too fast would break the MQTT broker connection
} 

void ECG()
{
  //typical data sample will be like 359, 378, 401
  Wire.requestFrom(10, 4); /* request data of size 4 from beetle at address 10 */
  ...
  if(Wire.available()){
    ...
    int ecgcount = 0;
    while(Wire.available() && ecgcount <4){ //check for 5 bytes of data
