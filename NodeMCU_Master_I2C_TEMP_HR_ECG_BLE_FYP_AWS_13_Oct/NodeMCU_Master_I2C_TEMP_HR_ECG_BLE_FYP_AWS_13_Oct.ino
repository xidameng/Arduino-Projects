...
//I2C address 9, 10 bytes requested
void HRSPO2(){
...
//////////////////////////
  ...
  Wire.requestFrom(9, 10); /* request data of size 10 from beetle at address 9, bcos the data is of form"-999[ENTER]-999[ENTER]" which are 10 bytes in total */
  ...
  if(Wire.available()){
    ...
    int hcount = 0;
    while(Wire.available() && hcount <10){ //check for 5 bytes of data
...
//////////////////////////////////////////////////////////////////////////
  ...
  ECG();
  delay(150); //150ms; Delays are here bcos publishing too fast would break the connection between ESP8266 and MQTT broker on AWS
  ECG();
  delay(150); //300ms
  ECG();
  delay(150); //450ms
