...
const char* mqttServer = "18.136.207.99";  //This is the IP address of the AWS server_Jessica's one
...
/*  For HR&SpO2 ble RX  */
  ...
  //Wait for 0.5 second after upload
  delay(200);
...
void polling()
{
  //Define every 2 seconds as 1 session
