...
//I2C address 9, 6 bytes requested
void HRSPO2(){
...
//////////////////////////
  ...
  Wire.requestFrom(9, 6); /* request data of size 5 from beetle at address 9 */
  ...
  if(Wire.available()){
    ...
    int hcount = 0;
    while(Wire.available() && hcount <6){ //check for 5 bytes of data
