...
/*  For temp ble RX  */
  ...
  Wire.requestFrom(8, 5); /* request data of size 7 from beetle at address 8 */
...
//      Serial.print("Temp received is : ");
//      Serial.println(temp_ble[tcount]);
      tcount++;
    }
  }
...
//   }
  ...
  //dtostrf(temp_ble,10,2,temp_blebuffer);
    ...
    //Delay for a while to upload the data
    digitalWrite(LED_BUILTIN,HIGH);
    delay(50);
    digitalWrite(LED_BUILTIN,LOW);
    delay(50);
